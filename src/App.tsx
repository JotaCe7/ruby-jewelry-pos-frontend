  ...
  return (
    <div className="min-h-screen bg-ruby-950 text-blush-100">
      <header className="border-b border-ruby-800 bg-ruby-900 px-6 py-4">
        <h1 className="text-lg font-bold tracking-wide text-blush-200">
          {t("app.name")}
        </h1>
      ...
      <main className="p-6">
        <Routes>
          ...
          <Route path="/catalogs" element={<ModulePlaceholder titleKey="nav.catalogs" />} />
          <Route path="/contacts" element={<ModulePlaceholder titleKey="nav.contacts" />} />
